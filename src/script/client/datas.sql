...
('Martin', 'Pierre', '1982-10-10', 'pierre.martin1@example.com',digest('12345','sha1'), 'GEN1', 'CTU1'),
('Lefevre', 'Emma', '1995-03-25', 'emma.lefevre1@example.com',digest('12345','sha1'), 'GEN2', 'CTU2'),
('Leroy', 'Luc', '1998-07-30', 'luc.leroy1@example.com',digest('12345','sha1'),'GEN2', 'CTU2');
...
INSERT INTO Evenement (description,titre_evenement, id_hotel, id_categorie_evenement) VALUES
('Conférence sur le développement durable', 'Conférence Éco', 'HOT1', 'CEV1'),
('Concert de Jazz en plein air', 'Jazz sous les Étoiles', 'HOT1','CEV2'),
('Festival de été','Festival Été 2023', 'HOT3','CEV3'),
('Match de Hockey','Hockey sur Glace', 'HOT4', 'CEV4'),
('Exposition  Art Moderne','Expo Art Moderne','HOT5', 'CEV5');
