...
<%@ page import="stat.StatReservationMensuelTransport" %>
...
<%
    ...
    List<StatReservationMensuelTransport> nombre_reservations = (List<StatReservationMensuelTransport>) request.getAttribute("statReservationMensuelTransport");
    for (StatReservationMensuelTransport v_nombre_reservations : nombre_reservations) {
...
<a class="btn abeona-custom_4" href="TraitementStatReservationMensuelHotel">Hotel</a>
<a class="btn abeona-custom_4 active" href="TraitementStatReservationMensuelTransport">Transport</a>
</div>
</div>
...
<div class="chart_header">
    ...
    <div class="options_container">
        <div class="input-section type2">
            <form action="TraitementStatReservationMensuelTransport" method="post">
