...
<%@ page import="stat.StatReservationMensuelGeneral" %>
...
<%
    ...
    List<StatReservationMensuelGeneral> nombre_reservations = (List<StatReservationMensuelGeneral>) request.getAttribute("statReservationMensuelGeneral");
    for (StatReservationMensuelGeneral v_nombre_reservations : nombre_reservations) {
...
<div class="button-group row">
    <a class="btn abeona-custom_4 active" href="TraitementStatReservationMensuelGeneral">General</a>
...
<div class="chart_header">
    ...
    <div class="options_container">
        <div class="input-section type2">
            <form action="TraitementStatReservationMensuelGeneral" method="post">
